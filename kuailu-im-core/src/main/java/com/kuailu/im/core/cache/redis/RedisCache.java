...
//import com.kuailu.im.core.cache.ICache;
//import com.kuailu.im.core.cache.redis.JedisTemplate.Pair;
//import com.kuailu.im.core.cache.redis.JedisTemplate.PairEx;
...
//            JedisTemplate.me().set(cacheKey, value, Integer.parseInt(timeout + ""));
//        } catch (Exception e) {
//            log.error(e.toString(), e);
//        }
//    }
...
//        }
//        try {
//            Set<String> dataSet = JedisTemplate.me().sorSetRangeByScore(cacheKey(cacheName, key), Long.MIN_VALUE, Long.MIN_VALUE);
//            if (dataSet == null) {
//                return null;
//            }
...
//    }
//
//    public List<String> sortSetGetAll(String key, long min, long max) {
//        if (StringUtils.isBlank(key)) {
//            return null;
//        }
//        try {
...
//    }
//
//    public List<String> revrangeSortSetGetAll(String key) {
//        if (StringUtils.isBlank(key)) {
//            return null;
//        }
//        try {
//            Set<String> dataSet = JedisTemplate.me().sorSetRangeByScore(cacheKey(cacheName, key), Long.MAX_VALUE, 0);
//            if (dataSet == null) {
//                return null;
//            }
//            return new ArrayList<String>(dataSet);
...
//    }
//
//    public List<String> revrangeSortSetGetAll(String key, long min, long max) {
//        if (StringUtils.isBlank(key)) {
//            return null;
//        }
//        try {
//            Set<String> dataSet = JedisTemplate.me().revrangeByScoreWithSortedSet(cacheKey(cacheName, key), max, min);
//            if (dataSet == null) {
//                return null;
//            }
//            return new ArrayList<String>(dataSet);
...
//    }
//
//    public List<String> revrangeSortSetGetAll(String key, long min, long max, int offset, int count) {
//        if (StringUtils.isBlank(key)) {
//            return null;
//        }
//        try {
