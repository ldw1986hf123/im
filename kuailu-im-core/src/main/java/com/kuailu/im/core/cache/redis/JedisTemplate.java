...
//					if(instance == null){
//						redisConfig =new RedisConfiguration(PropUtil.getProp().getProperties());
//						init();
...
//			throw new RuntimeException("cann't create JedisPool for server"+redisConfig.getHost());
//		}
//
//}
//
...
//    * @return
//    */
//   public Set<String> sorSetRangeByScore(final String key, final long min, final long max) {
//       return new Executor<Set<String>>(jedisPool) {
//
//           @Override
//           Set<String> execute() {
...
//    */
//   public Set<String> revrangeByScoreWithSortedSet(final String key, final long max, final long min) {
//       return new Executor<Set<String>>(jedisPool) {
//
//           @Override
//           Set<String> execute() {
...
//     * @return 指定区间内，带有 score 值(可选)的有序集成员的列表
//     */
//    public Set<String> revrangeByScoreWithSortedSet(final String key, final long max, final long min,final  int offset, final int count) {
//        return new Executor<Set<String>>(jedisPool) {
//
//            @Override
//            Set<String> execute() {
