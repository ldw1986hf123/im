 ...
 * 
 */
package com.kuailu.im.core.config;
...
import com.kuailu.im.core.listener.ImGroupListenerAdapter;
import com.kuailu.im.core.listener.ImListener;
import com.kuailu.im.core.listener.ImUserListener;
import com.kuailu.im.core.banner.JimBanner;
    ...
    public ImConfig(SynThreadPoolExecutor jimExecutor){
        ...
        if (this.jimExecutor == null) {
            ...
            this.jimExecutor = new SynThreadPoolExecutor(CORE_POOL_SIZE, CORE_POOL_SIZE, Threads.KEEP_ALIVE_TIME, timQueue,
                    DefaultThreadFactory.getInstance(ImConst.KIM, Thread.NORM_PRIORITY), ImConst.KIM);
