...
public class ImServerListenerAdapter implements ServerAioListener, ImConst {
	...
	public void onAfterSent(ChannelContext channelContext, Packet packet, boolean isSentSuccess)throws Exception{
		imServerListener.onAfterSent((ImChannelContext)channelContext.get(Key.IM_CHANNEL_CONTEXT_KEY),
				(ImPacket)packet, isSentSuccess);
	}
	...
	public void onBeforeClose(ChannelContext channelContext, Throwable throwable, String remark, boolean isRemove)throws Exception{
		...
		if(Objects.nonNull(imSessionContext)){
			...
			UserDto user = imServerChannelContext.getSessionContext().getImClientNode().getUser();
